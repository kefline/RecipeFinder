...
<!-- Mirrored from gico.io/spcica/category.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Oct 2024 20:00:53 GMT -->
<head>
<meta charset="utf-8">
<title>Spcica HTML Template | Category</title>
<!-- Stylesheets -->
						...
						<nav class="main-menu navbar-expand-md">
							...
							<div class="navbar-collapse show collapse clearfix" id="navbarSupportedContent">
								<ul class="navigation clearfix">
									...
									<li class="current"><a href="{{route('category')}}">Category</a></li>
                ...
                <div class="tab-btns-box">
					...
					<div class="tabs-header">
						<ul class="product-tab-btns clearfix">
							...
							<li class="p-tab-btn" data-tab="#p-tab-6">Coffee<span class="number">14</span></li>
							<li class="p-tab-btn" data-tab="#p-tab-7">Vegan<span class="number">12</span></li>
							<li class="p-tab-btn" data-tab="#p-tab-8">Dessert<span class="number">03</span></li>
							<li class="p-tab-btn" data-tab="#p-tab-9">BBQ<span class="number">08</span></li>
							<li class="p-tab-btn" data-tab="#p-tab-10">Juice<span class="number">04</span></li>
						</ul>
					</div>
				</div>
                    ...
                    <div class="p-tab" id="p-tab-3">
                        <div class="project-carousel owl-theme owl-carousel">
							...
							<div class="category-block">
								<div class="inner-box">
									<div class="image">
										<img src="images/resource/cat-3.png" alt="" />
									</div>
									<div class="lower-content">
										<h4><a href="recipes-detail.html">Ground Chicken Recipes</a></h4>
										<div class="text">Lorem ipsum dolor amet, consetec <br> adipiscing elit. magna lentesque.</div>
                    ...
                    <div class="p-tab" id="p-tab-4">
                        <div class="project-carousel owl-theme owl-carousel">
							...
							<div class="category-block">
								<div class="inner-box">
									<div class="image">
										<img src="images/resource/cat-1.png" alt="" />
									</div>
									<div class="lower-content">
										<h4><a href="recipes-detail.html">Cake recipe</a></h4>
										<div class="text">Lorem ipsum dolor amet, consetec <br> adipiscing elit. magna</div>
							...
							<div class="category-block">
								<div class="inner-box">
									<div class="image">
										<img src="images/resource/cat-2.png" alt="" />
									</div>
									<div class="lower-content">
										<h4><a href="recipes-detail.html">Christmas Recipes</a></h4>
										<div class="text">Lorem ipsum dolor amet, consetec adipiscing <br> elit. magna lentesque.</div>
		...
		<div class="auto-container">
			...
			<div class="row clearfix">
				...
				<div class="entertaining-block col-lg-3 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="recipes-detail.html"><img src="images/resource/entertaining-1.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<ul class="post-meta">
				...
				<div class="entertaining-block col-lg-3 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="recipes-detail.html"><img src="images/resource/entertaining-2.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<ul class="post-meta">
								<li><span class="icon "></span>21 Jan ,2020</li>
				...
				<div class="entertaining-block col-lg-3 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="recipes-detail.html"><img src="images/resource/entertaining-3.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<ul class="post-meta">
								<li><span class="icon "></span>21 Jan ,2020</li>
				...
				<div class="entertaining-block col-lg-3 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="recipes-detail.html"><img src="images/resource/entertaining-4.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<ul class="post-meta">
								<li><span class="icon "></span>21 Jan ,2020</li>
